...
//    self.gainsarray = [NSMutableArray new];
    ...
    self.coinTypeArray = @[[NSNumber numberWithInteger:MIS],[NSNumber numberWithInteger:BTC],[NSNumber numberWithInteger:ETH],[NSNumber numberWithInteger:EOS],[NSNumber numberWithInteger:USDT]];
    //默认关闭
    self.sectionIsOpen = [@[@0,@0,@0,@0,@0] mutableCopy];
    MJWeakSelf
    self.allWalletDic = [@{[NSNumber numberWithInteger:MIS]:weakSelf.miswalletArray,[NSNumber numberWithInteger:BTC]:weakSelf.btcwalletArray,
    ...
    self.allWalletBalanceDic = [@{[NSNumber numberWithInteger:MIS]:weakSelf.misBalance,[NSNumber numberWithInteger:BTC]:weakSelf.btcBalance,
...
//            cell.rmbvaluelb.text = [NSString stringWithFormat:@"≈¥%.2f", ethbalance * self.self.ETHCurrency * (self.RMBDollarCurrency / 100.0)];
        ...
        }else if(cointype.integerValue == MIS){
            NSString *name = @"MIS";

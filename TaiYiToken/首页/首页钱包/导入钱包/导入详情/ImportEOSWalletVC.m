...
@interface ImportEOSWalletVC ()<UIImagePickerControllerDelegate>
...
@implementation ImportEOSWalletVC

-(void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:YES];
    [MobClick beginLogPageView:@"ImportEOSWalletVC"];
...
-(void)viewWillDisappear:(BOOL)animated{
    ...
    [MobClick endLogPageView:@"ImportEOSWalletVC"];
...
-(void)initHeadView{
    ...
    [_titleLabel setText:[NSString stringWithFormat:NSLocalizedString(@"导入EOS钱包", nil)]];
...
//        CoinType typex = EOS;
        ...
        MissionWallet *eoswallet = [self CreateEOSWalletPri:mispri Pub:pubx PassWord:password PassHint:hint CoinType:EOS];

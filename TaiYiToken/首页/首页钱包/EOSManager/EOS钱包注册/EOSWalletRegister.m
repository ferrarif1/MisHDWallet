...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"EOSWalletRegister"];
}
-(void)viewWillDisappear:(BOOL)animated{
    ...
    [MobClick endLogPageView:@"EOSWalletRegister"];
}
- (void)popAction{
...
-(void)initHeadView{
    ...
    _titlelabel.text = NSLocalizedString(@"EOS账户", nil);
...
-(void)setMainSrollView{
    _mainScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, SafeAreaTopHeight + 44, ScreenWidth, self.view.frame.size.height)];

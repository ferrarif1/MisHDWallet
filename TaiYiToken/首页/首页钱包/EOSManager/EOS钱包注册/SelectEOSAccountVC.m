...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"SelectEOSAccountVC"];
}
-(void)viewWillDisappear:(BOOL)animated{
    self.tabBarController.tabBar.hidden = NO;
    [MobClick endLogPageView:@"SelectEOSAccountVC"];
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (self.accountArray.count > indexPath.row) {
        ...
        self.wallet.walletName = [NSString stringWithFormat:@"EOS_%@",accountname];
        ...
        if (_wallet.walletType == LOCAL_WALLET) {
            ...
            [[NSUserDefaults standardUserDefaults] setObject:self.wallet.walletName forKey:@"LocalEOSWalletName"];

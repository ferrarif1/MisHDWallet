...
-(void)drawRect:(CGRect)rect{
    ...
    NSString *texttotal = [NSString stringWithFormat:@"%@ %.4f EOS",NSLocalizedString(@"总资产", nil),_total];
    ...
    NSString *text00 = [NSString stringWithFormat:@"%.4f EOS",_balance];
    ...
    NSString *text01 = [NSString stringWithFormat:@"%.4f EOS",_reclaiming];
    ...
    NSString *text02 = [NSString stringWithFormat:@"%.4f EOS",_staked];

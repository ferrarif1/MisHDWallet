...
-(void)drawRect:(CGRect)rect{
    ...
    NSString *ramremindtext = NSLocalizedString(@"说明：内存需要使用EOS购买", nil);
...
-(UIButton *)ramBtn{
    if (!_ramBtn) {
        ...
        _ramBtn.backgroundColor = [UIColor whiteColor];
        [_ramBtn setImage:[UIImage imageNamed:@"ico_left_arrow"] forState:UIControlStateNormal];
        _ramBtn.imageEdgeInsets=UIEdgeInsetsMake(0, 30, 0, 0);
...
-(UIButton *)cnBtn{
    if (!_cnBtn) {
        ...
        _cnBtn.imageEdgeInsets=UIEdgeInsetsMake(0, 30, 0, 0);

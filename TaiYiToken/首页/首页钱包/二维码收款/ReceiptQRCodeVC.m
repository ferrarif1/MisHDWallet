...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"ReceiptQRCodeVC"];
...
-(void)viewWillDisappear:(BOOL)animated{
    ...
    [MobClick endLogPageView:@"ReceiptQRCodeVC"];
...
//    }
    ...
    if (_wallet.coinType == BTC || _wallet.coinType == ETH || _wallet.coinType == USDT) {
        ...
        NSString *name = [_wallet.walletName componentsSeparatedByString:@"_"].lastObject;
        NSString *symbolname = [NSString stringWithFormat:@"@MIS@%@",name];
        _QRCodeiv.image = [CreateAll CreateQRCodeForAddress:symbolname];

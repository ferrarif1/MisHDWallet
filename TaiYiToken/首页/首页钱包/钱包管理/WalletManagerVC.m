...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (wallet && (wallet.coinType == BTC || wallet.coinType == BTC_TESTNET)) {
        ...
        UIImage *backImage = [[UIImage alloc]createImageWithSize:CGSizeMake(312, 155) gradientColors:@[[UIColor colorWithHexString:@"#7B48DA"],[UIColor colorWithHexString:@"#8C6AE0"]] percentage:@[@(0.3),@(1)] gradientType:GradientFromLeftTopToRightBottom];
        [cell.backImageViewLeft setImage:backImage];
